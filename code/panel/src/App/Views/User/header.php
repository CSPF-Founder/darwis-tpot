    ...
    <div class="sidebar sidebar-light sidebar-fixed" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            <li class=" nav-item">
                ...
                <a class="nav-link" target="_blank" href="https://<?php View::securePrint(Utils::getUntrustedHost() . ':64297'); ?>/map">
                    <i class="fa fa-regular fa-map nav-icon"></i> Attack Map
                </a>
                <a class="nav-link" target="_blank" href="https://<?php View::securePrint(Utils::getUntrustedHost() . ':64297'); ?>/kibana">
                    <i class="fa fa-regular fa-chart-bar nav-icon"></i> Kibana
                </a>
